...
class MultiPredictionModel(object):
    ...
    def __init__(self, df, xsize=0.5, ysize=0.5, xslide=0.25, yslide=0.25, xcol='x', ycol='y', n_estimators=10, n_jobs=1):
        ...
        self.actual = None
        self.result_set = {}
        self.features = ['x', 'y', 'accuracy', 'hour', 'day', 'week', 'month', 'year', 'log2_accuracy', 'accu_class']
    ...
    def predict(self, df, test=False):
        ...
        with open('low_prob.json', 'w') as f3:
            f3.write(json.dumps(self.low_prob))
